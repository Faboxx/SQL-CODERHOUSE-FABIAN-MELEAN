...
-- TABLA PARA PAGOS DEL ECOMMERCE.
...
CREATE TABLE PAGOS (
    ...
    MONTO DECIMAL(10, 2),
    FECHA DATETIME,
    FOREIGN KEY (IDPEDIDORESERVA) REFERENCES PEDIDOS(IDPEDIDORESERVA),
    FOREIGN KEY (IDMETODO_PAGO) REFERENCES METODOS_PAGO(IDMETODO_PAGO)
);
